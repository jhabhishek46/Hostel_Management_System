...
app.config['MYSQL_PASSWORD'] = 'abhi8834'
app.config['MYSQL_DB'] = 'hostel_db_nitw'
mysql=MySQL(app)
...
def init_app():
    session['hostelname'] = 'WELCOME TO NIT WARANGAL'
    session['show'] = True
...
def apj():
    session['show'] = False
    session['hostelname']='ULTRA MEGA'
    cur = mysql.connection.cursor()
    cur.execute("SELECT * FROM staff WHERE hostelname=%s", ('ULTRA MEGA HALL OF RESIDENCE',))
    x = cur.fetchall()
    x1 = x[0]
    x = x[1:]
...
@app.route('/vsb')
def vsb():
    session['hostelname']='MEGA'
    cur=mysql.connection.cursor()
    cur.execute("SELECT * FROM staff WHERE hostelname=%s",('MEGA HALL OF RESIDENCE',))
    x=cur.fetchall()
    x1=x[0]
    x=x[1:]
    return render_template('vsb.html',items=x,items1=x1)
...
@app.route('/cvr')
def cvr():
    session['hostelname']='BLOCK 8'
    cur = mysql.connection.cursor()
    cur.execute("SELECT * FROM staff WHERE hostelname=%s", ('BLOCK 8 HALL OF RESIDENCE',))
    x = cur.fetchall()
    x1 = x[0]
    x = x[1:]
    return render_template('vsb.html', items=x, items1=x1)
...
@app.route('/devi')
def devi():
    session['hostelname']='SAROJINI'
    cur = mysql.connection.cursor()
    cur.execute("SELECT * FROM staff WHERE hostelname=%s", ('SAROJINI HALL OF RESIDENCE',))
    x = cur.fetchall()
    x1 = x[0]
    x = x[1:]
    return render_template('vsb.html', items=x, items1=x1)
...
@app.route('/homi')
def homi():
    session['hostelname']='BLOCK 14'
    cur = mysql.connection.cursor()
    cur.execute("SELECT * FROM staff WHERE hostelname=%s", ('BLOCK 14 HALL OF RESIDENCE',))
    x = cur.fetchall()
    x1 = x[0]
    x = x[1:]
    return render_template('vsb.html', items=x, items1=x1)
...
@app.route('/jcb')
def jcb():
    session['hostelname']='PRIYADARSHINI'
    cur = mysql.connection.cursor()
    cur.execute("SELECT * FROM staff WHERE hostelname=%s", ('PRIYADARSHINI HALL OF RESIDENCE',))
    x = cur.fetchall()
    x1 = x[0]
    x = x[1:]
    return render_template('vsb.html', items=x, items1=x1)
    ...
    if(request.method=='POST'):
        ...
        if(x1!=0):
            ...
            if(data[3]=='1'):
                ...
                session['hostelname']='MEGA HALL OF RESIDENCE'
            else:
...
@app.route('/abdul')
def abdul():
    session['hostelname']='ULTRA MEGA HALL OF RESIDENCE'
    return redirect(url_for('admin'))
@app.route('/devia')
def devia():
    session['hostelname']='SAROJINI HALL OF RESIDENCE'
    return redirect(url_for('admin'))
@app.route('/cvraman')
def cvraman():
    session['hostelname']='BLOCK 8 HALL OF RESIDENCE'
    return redirect(url_for('admin'))
@app.route('/homijangir')
def homijangir():
    session['hostelname']='BLOCK 14 HALL OF RESIDENCE'
    return redirect(url_for('admin'))
@app.route('/jcbose')
def jcbose():
    session['hostelname']='PRIYADARSHINI HALL OF RESIDENCE'
    return redirect(url_for('admin'))
